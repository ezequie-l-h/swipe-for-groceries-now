      ...
      <div className="flex items-center gap-4">
        {totalSavings > 0 && (
          <div className="relative">
            ...
            <div className={`relative bg-gradient-to-r ${tierInfo.bgColors} text-white px-6 py-4 rounded-lg shadow-lg transform hover:scale-105 transition-all duration-300 min-w-[220px]`}>
              <div className="flex items-center gap-4">
                <div className="relative">
                ...
                <div className="flex flex-col flex-1">
                  <span className="text-sm font-medium opacity-90 mb-1">You Saved</span>
